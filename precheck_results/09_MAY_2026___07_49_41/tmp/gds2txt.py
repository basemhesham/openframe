...
input_layout = "/tmp/tmplp50_0bl/repo/gds/openframe_project_wrapper.gds"
output = "/tmp/tmplp50_0bl/repo/precheck_results/09_MAY_2026___07_49_41/tmp/layout.txt"
...
for cell_it in layout_view.each_cell():
    if cell_it.name.endswith("openframe_project_wrapper"):
